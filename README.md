# Instructions for use of CalVin - Chatbot and Assistant

CalVin is a program and chatbot that can be trained to learn how to respond to users and help them in day to day activity. He maintains a pleasant conversation with the user and can respond based on inputs that best match his knowledge base. 

## Features:
- Greet the user and respond to them
- Ability to check the weather forecast
- Trainable interface that allows programmers to customize his responses and features
